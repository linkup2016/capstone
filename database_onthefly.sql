...
create table chartOfAccounts(
    ...
    accountTitle varchar(140) NOT NULL,
...
create table generalJournal(
    ...
    foreign key (accountTitle) references chartOfAccounts(accountTitle)
);

INSERT INTO generalJournal(transactionDate, description, accountTitle, debit, credit) 
  
VALUES ("samuel", "sam2017", NOW()),("helen", "helen2017", NOW());

INSERT INTO user(userID, password, registrationDate) 
